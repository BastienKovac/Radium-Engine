    ...
    namespace Engine
    {
        ...
        public:
            ...
            struct PickingResult
            {
                ...
                // Note: There is exactly one triplet for each querried pixel (thus there can be doublons coming from pixels).
                // Note: Beware that the same mesh vertex would also be picked for each of its adjacent triangles.
            };
